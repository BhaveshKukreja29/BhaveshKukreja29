...
* **King's Gambit:** A full-stack, real-time chess platform with a React and Django, including WebRTC video chat. [GitHub](https://github.com/BhaveshKukreja29/KingsGambit)
...
* How Python lists use a dynamic C array for performance: [Blog](https://dev.to/bhavesh_kukreja/how-do-lists-really-work-in-python-4cmn)
* Explaining Python's dictionary structure and O(1) lookups: [Blog](https://dev.to/bhavesh_kukreja/a-deep-dive-into-python-dictionaries-4758)
